...
(function ($) {
      ...
      if (typeof gigya !== 'undefined') {
        try {
          ...
          if (Drupal.settings.gigyaExtra.sessionMode === 'gigya') {
            if (Drupal.settings.gigyaExtra.isGigyaLogin && !Drupal.settings.gigyaExtra.isLogin) {
   ...
   * @param settings
   *
   * @property Drupal.gigya.notifyFriendsCallback
   */
    attach: function (context, settings) {
      if (typeof gigya !== 'undefined') {
  ...
  Drupal.behaviors.gigyaRassDynamicSession = {
    attach: function (context, settings) {
      if (Drupal.settings.gigyaExtra.sessionType === 'dynamic' && !Drupal.settings.gigyaExtra.bypassRaas) {
        $('body').append('<div id="gigyaRequestFormsExt"></div>');

        var base = 'gigyaRequestFormsExt',
          element_settings = {},
          id = "#" + base;
        element_settings.url = getUrlPrefix() + 'gigya/extcookie';
        element_settings.event = 'gigyaExtcookie';
        var ajax = new Drupal.ajax(base, $(id), element_settings);
        $(id).trigger('gigyaExtcookie').unbind('gigyaExtcookie');
      }
    }
  };
   ...
   * @param settings
   *
   * @property Drupal.settings.gigya.connectUIParams
   * @property Drupal.settings.gigya.loginMode
   * @property Drupal.settings.gigya.loginUIParams
   * @property Drupal.settings.gigya.notifyLoginParams
   * @property Drupal.settings.gigya.shareUIParams
   * @property Drupal.settings.gigya.shareUIParams.extraParams
   * @property Drupal.settings.gigya.shareUIParams.imageBhev
   * @property Drupal.settings.gigya.shareUIParams.imageUrl
   * @property Drupal.settings.gigya.shareUIParams.linkBack
   * @property gigya.accounts
   * @property gigya.services
   */
    attach: function (context, settings) {
      if (typeof gigya !== 'undefined') {
        $('body').append('<div id="gigyaRequestForms"></div>');
    ...
    attach: function (context, settings) {
      if (typeof gigya !== 'undefined') {
        if ($.cookie('Drupal.visitor.gigya') === 'gigyaLogOut') {
          ...
          $.cookie('Drupal.visitor.gigya', null, { path: '/' });
        }
      }
    }
  };
   ...
   * @param settings
   *
   * @property Drupal.settings.gigya.raas
   */
    attach: function (context, settings) {
      if (typeof gigya !== 'undefined') {
        if (Drupal.settings.gigya.loginMode === 'raas') {
